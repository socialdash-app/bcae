...
const init = () => {
  ...
  let height = navigation.getBoundingClientRect().height;
...
// let boxes = document.querySelectorAll("li");
  ...
  boxes.forEach((box, i) => {
    ...
    box.addEventListener('click', () => {
      console.log(height * (i / boxes.length - 1))
      document.querySelector('main').scrollTo({top: height * (i / (boxes.length + 1)), behavior: 'smooth'});
